  ...
  <div>
    ...
    <div class="h-14 bg-yellow-500 px-4 flex items-center justify-between">
      <div class="flex gap-4 items-center">
        ...
        >
          <img class="w-full h-full object-cover" :src="data.pic" alt="" />
        </div>
        <span class="text-[#00473E] font-bold">{{ data.label }}</span>
      </div>
    ...
    >
      ...
      <!-- Messages -->
      <MessagesList :messages="messages" :isProcessing="context.isProcessing" />
    </div>
...
import { parseTime, sendReq } from "../utils";
...
const messages = ref();
const welcomeMsg = ref(props.data.msg.title);
...
watch(
  ...
  () => {
    messages.value = [
      {
        author_pic: props.data.pic,
        msg: props.data.msg.title,
        mine: false,
